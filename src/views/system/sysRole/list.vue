    ...
    <div class="app-container">
        ...
        <div class="search-div">
            <el-form label-width="70px" size="small">
                ...
                <el-row style="display:flex">
                    ...
                    <!-- 工具条 -->
                    <div class="tools-div" style="float:right;">
                        <el-button type="success"
                         icon="el-icon-plus" 
                         size="mini" @click="add" :disabled="$hasBP('bnt.sysRole.add')=== false">
                         添 加</el-button>
                    </div>
                    <el-button @click="batchRemove()" icon="el-icon-delete" type="danger" size="mini">删除</el-button>
                </el-row>
            ...
            <el-table-column label="操作" width="260" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button type="warning" icon="el-icon-baseball" size="mini" @click="showAssignAuth(scope.row)"
                        title="分配权限" :disabled="$hasBP('bnt.sysRole.assign')=== false" />
                </template>
            </el-table-column>
        </el-table>
        <!-- 分页组件 -->
        ...
        <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="40%">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogVisible = false" size="small" icon="el-icon-refresh-right">
                    取 消
                </el-button>
                <el-button type="primary" icon="el-icon-check" @click="saveOrUpdate()" size="small">
                    确 定</el-button>
