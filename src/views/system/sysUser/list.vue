        ...
        <el-table v-loading="listLoading" :data="list" stripe border style="width: 100%;margin-top: 10px;">
            ...
            <el-table-column label="操作" width="240" align="center" fixed="right">
                <template slot-scope="scope">
                    ...
                    type="danger" 
                    icon="el-icon-delete" 
                    size="mini" @click="removeDataById(scope.row.id)"
                        title="删除" :disabled="$hasBP('bnt.sysUser.delete')  === false"/>
                    <el-button type="warning" 
                    icon="el-icon-baseball" size="mini"
                     @click="showAssignRole(scope.row)"
                        title="分配角色" :disabled="$hasBP('bnt.sysUser.assign')  === false" />
                </template>
            </el-table-column>
        </el-table>
            ...
            <el-form label-width="80px">
                ...
                <el-form-item label="角色列表">
                    ...
                    <el-checkbox-group v-model="userRoleIds" @change="handleCheckedChange">
                        ...
                        :key="role.id" :label="role.id">{{role.roleName}}</el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
            </el-form>
            <div slot="footer">
